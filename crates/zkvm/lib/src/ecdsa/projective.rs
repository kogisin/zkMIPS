...
impl<C: ECDSACurve> ProjectivePoint<C> {
    ...
    fn to_zkvm_point(self) -> C::ZKMAffinePoint {
        self.inner.inner
    }

    fn as_zkvm_point(&self) -> &C::ZKMAffinePoint {
        &self.inner.inner
    }

    fn as_mut_zkvm_point(&mut self) -> &mut C::ZKMAffinePoint {
    ...
    fn from_zkvm_point(p: C::ZKMAffinePoint) -> Self {
